...
namespace LABA8
{
    ...
    { 
        ...
        public Rectagle(string name, int w, int y, int x, int h)
        {
       ...
       public override void Draw()
        {
            ...
            || (this.y + this.h> Init.pictureBox.Height)
            ...
            || (this.x < 0)))
            {
                ...
                IsDraw = true;
                //MessageBox.Show("Рисование работает правильно!");
            }
            else
            {
        ...
        public virtual void AddContainerL9(string name)
        {
            if (IsDraw)
            {
                ShapeContainer.AddFigureL9(this, name);
            }
            else
            {
